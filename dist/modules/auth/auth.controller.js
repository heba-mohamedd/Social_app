...
authRouter.patch("/resend-otp", (0, validation_1.Validation)(auth_validation_1.resendOtpSchema), auth_service_1.default.resendOtp);
...
authRouter.get("/profile", authentication_1.authentication, (0, authorization_1.authorization)([user_enum_1.RoleEnum.user]), auth_service_1.default.getProfile);
authRouter.get("/logout", authentication_1.authentication, auth_service_1.default.logout);
authRouter.post("/upload", authentication_1.authentication, (0, multer_cloud_1.default)().single("attachment"), auth_service_1.default.uploadProfileImage);
